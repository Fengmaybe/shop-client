<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="handleShowContent">
    ...
    <div class="shop-brief-modal" v-show="isShowShopBrief">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="handleShowContent">
    ...
    <div class="activity-sheet" v-show="isShowSheet">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="handleDiscounts">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
...
<script>
  ...
  export default {
    data () {
      return {
        colorArray:['activity-green','activity-red','activity-orange'],
